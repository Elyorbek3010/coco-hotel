...
export default function PromotionsPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* 2. PROMOTIONS LIST */}
      <section aria-label="Available Offers" className="py-16 sm:py-24">
        <Container>
          {loading ? (
            ...
            <div className="text-center py-16 px-6 bg-stone-50 border border-stone-200 rounded-sm max-w-xl mx-auto space-y-4">
              <span className="inline-block p-3 rounded-full bg-stone-100 text-stone-400">
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center px-6 py-2.5 text-xs font-semibold uppercase tracking-wider border border-stone-300 text-stone-800 hover:bg-stone-50 rounded-sm transition-colors"
                >
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {promotions.map((promo) => (
                  <article
                    key={promo.id}
                    className="bg-white border border-stone-200 rounded-sm overflow-hidden shadow-xs hover:shadow-md transition-shadow flex flex-col"
                  >
                    {promo.image && (
                    ...
                    <div className="p-6 sm:p-8 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto pt-4 border-t border-stone-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                        ...
                        <Link
                          ...
                          className="font-semibold text-amber-800 hover:text-amber-900 self-start sm:self-auto inline-flex items-center gap-1 focus-visible:outline-2 focus-visible:outline-amber-700 rounded-xs"
                        >
                          View Details &rarr;
                        </Link>
                      </div>
