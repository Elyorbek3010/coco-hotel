        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <div>
            <label
              ...
              className="block text-xs font-semibold uppercase tracking-wider text-stone-300 mb-1"
            >
              Preferred Call Time <span className="text-stone-500 font-normal">(Optional)</span>
            </label>
            <input
              ...
              disabled={submitting}
              className="w-full px-3.5 py-2.5 text-sm bg-[#1a1714] border border-stone-800 text-stone-100 placeholder-stone-600 rounded-sm focus:border-[#c5a880] focus:ring-1 focus:ring-[#c5a880] focus:outline-none transition-colors disabled:bg-stone-900 disabled:cursor-not-allowed"
            />
          </div>
          ...
          <div>
            <label
              ...
              className="block text-xs font-semibold uppercase tracking-wider text-stone-300 mb-1"
            >
              Inquiry Note <span className="text-stone-500 font-normal">(Optional)</span>
            </label>
            <textarea
              id="callback_message"
              name="message"
              ...
              disabled={submitting}
              className="w-full px-3.5 py-2.5 text-sm bg-[#1a1714] border border-stone-800 text-stone-100 placeholder-stone-600 rounded-sm focus:border-[#c5a880] focus:ring-1 focus:ring-[#c5a880] focus:outline-none transition-colors disabled:bg-stone-900 disabled:cursor-not-allowed resize-y"
            />
          </div>
